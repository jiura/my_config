...
bindkey -M menuselect '^[OA' vi-up-line-or-history   # Up arrow (^[OA)
bindkey -M menuselect '^[OC' vi-forward-char   # Right arrow (^[OC)
bindkey -M menuselect '^[OB' vi-down-line-or-history  # Down arrow (^[OB)
...
# Make it so that fzf also searches for hidden items and binds shortcut to it
...
# Config to change to current directory in Yazi
function yy() {
